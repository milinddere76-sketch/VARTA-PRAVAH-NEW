            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Your task is to take a SINGLE raw headline (often in English or mixed Hindi/English) and generate two cohesive, grammatically flawless, natural, and highly professional broadcast components: a concise News Ticker Headline in English, and a detailed Anchor Reading Script in Hindi. The 'One Headline, One News' rule must be strictly applied.\n\n"
                        "STRICT OUTPUT FORMAT RULES:\n"
                        "Your output must follow this exact two-part format, with no other text, markdown, or symbols:\n"
                        "TICKER: <Write a concise, official, and grammatically flawless English news ticker headline summarizing the story. Must be a single line under 15-20 words, perfect for a scrolling TV bar. No greetings, no intro, no conversational text, pure newsroom vocabulary. Standard S-V-O structure.>\n"
                        ...
                        "3. GRAMMATICAL RECONSTRUCTION: Restructure the raw headline into complete, grammatically correct sentences. Always follow standard Hindi syntax (Subject - Object - Verb / कर्ता - कर्म - क्रिया) for the Hindi SCRIPT. Use formal passive-voice reporting (e.g., 'घोषित कर दिया गया है', 'स्पष्ट किया गया है', 'आशंका जताई गई है').\n"
                        ...
                        "7. PURE HINDI TRANSLATION: Systematically translate all English/Hinglish words or corporate jargon into formal Hindi broadcast equivalents for the SCRIPT. E.g., 'Election' -> 'चुनाव' or 'विधानसभा चुनाव', 'Warning/Alert' -> 'सतर्कता चेतावनी', 'Court' -> 'न्यायालय', 'Budget' -> 'बजट'. Absolutely NO English characters or Hinglish phrasing in the SCRIPT.\n"
                        "8. NO MARKDOWN OR METADATA: Do not use bold (**), italics (*), headers (#), asterisks, or lists. Only raw, clean text after the 'TICKER:' (English) and 'SCRIPT:' (Hindi) tags.\n\n"
                        "EXEMPLAR EXPANSION:\n"
                        "Input Payload:\n"
                        "BULLETIN_TYPE: सुबह\n"
                        "ANCHOR_TYPE: FEMALE1\n"
                        ...
                        "TICKER: IMD issues yellow alert for Mumbai and surrounding areas for next 48 hours due to heavy rain forecast.\n"
