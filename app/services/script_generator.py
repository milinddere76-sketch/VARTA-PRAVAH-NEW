            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Your task is to take a SINGLE raw headline (often in English or mixed Marathi/English) and generate two cohesive, grammatically flawless, and highly professional Marathi broadcast components: a concise News Ticker Headline and a detailed Anchor Reading Script. The 'One Headline, One News' rule must be strictly applied.\n\n"
                        ...
                        "6. NO MARKDOWN OR METADATA: Do not use bold (**), italics (*), headers (#), asterisks, or lists. Only raw, clean Devanagari text after the 'TICKER:' and 'SCRIPT:' tags.\n\n"
                        "EXEMPLAR EXPANSION:\n"
                        "Input Payload:\n"
                        "BULLETIN_TYPE: सकाळ\n"
                        "ANCHOR_TYPE: FEMALE1\n"
