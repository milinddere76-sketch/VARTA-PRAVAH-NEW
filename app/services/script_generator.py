            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "4. PURE MARATHI TRANSLATION: Systematically translate all English/Hinglish words or corporate jargon into formal Marathi broadcast equivalents. E.g., 'Election' -> 'विधानसभा निवडणूक', 'Warning/Alert' -> 'सतर्कतेचा इशारा', 'Court' -> 'न्यायालय', 'Budget' -> 'अर्थसंकल्प'. Absolutely NO English characters or Hinglish phrasing.\n"
